...
using eAppointmentServer.Application.Faatures.Doctors.DeleteDoctorById;
using eAppointmentServer.Application.Faatures.Doctors.GetAllDoctor;
...
namespace eAppointmentServer.WebAPI.Controllers
{
    public class DoctorsController : ApiController
    {
        ...
        public async Task<IActionResult> GetAll(GetAllDoctorQuery request, CancellationToken cancellationToken)
        {
            ...
            //var response = Result<string>.Failure(new List<string> { "Exaple error1", "Exaple error2" });
